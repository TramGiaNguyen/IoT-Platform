...
CREATE TABLE `nguoi_dung` (
  ...
  `phai_doi_mat_khau` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `thiet_bi` (
  ...
  `is_analyzed` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '1 = device payload has been analyzed by AI pipeline',
...
-- ============================================================
-- Standalone ESP Controller Configurations
-- ============================================================
CREATE TABLE IF NOT EXISTS `standalone_configs` (
    ...
    `board_type` VARCHAR(16) NOT NULL DEFAULT 'esp32',
    `orientation` VARCHAR(16) NOT NULL DEFAULT 'portrait',
    `server_port` INT NOT NULL DEFAULT 80,
    `server_endpoint` VARCHAR(32) NOT NULL DEFAULT 'control',
    `ap_local_ip` VARCHAR(45) NOT NULL DEFAULT '192.168.4.1',
    `ap_gateway` VARCHAR(45) NOT NULL DEFAULT '192.168.4.1',
    `ap_subnet` VARCHAR(45) NOT NULL DEFAULT '255.255.255.0',
...
-- ============================================================
-- AI Analytics Tables (Phase 1: Core Infrastructure)
-- ============================================================
