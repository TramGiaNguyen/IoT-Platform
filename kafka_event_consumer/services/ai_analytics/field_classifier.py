...
class FieldRoleClassifier:
    ...
    SENSOR_DICTIONARIES = {
        'temperature': [
            'temperature', 'temp', 'tmp', 't', 't1', 't2', 't3',
            'air_temp', 'room_temp', 'ambient_temp', 'cpu_temp',
            'sensor_temp', 'temperature_c', 'temp_c', 'tc', 'airtemperature',
            'soil_temp', 'water_temp', 'surface_temp', 'obj_temp', 'target_temp',
            'max_temp', 'min_temp', 'internal_temp', 'external_temp'
        ],
        'humidity': [
    ...
    HARDWARE_SIGNATURES = {
        ...
        'Capacitive_Soil': {'fields': ['soil_moisture'], 'moisture_range': (0, 100)},
        # Waterproof Temperature Sensors
        'Waterproof_Temp': {'fields': ['temperature'], 'temp_range': (-10, 100)},
        # Current Transformers
        'SCT013': {'fields': ['current'], 'current_range': (0, 100)},
        # Light Sensors
        'GL5528': {'fields': ['light'], 'resistance_range': (1, 10000)},
        'Photoresistor': {'fields': ['light'], 'has_analog': True},
        # Motion Sensors
        'RCW_001': {'fields': ['motion'], 'has_radar': True},
        'PIR': {'fields': ['motion', 'pir'], 'has_pir': True},
        # Gas Sensors
        'MQ2_Smoke': {'fields': ['gas', 'smoke'], 'has_smoke': True},
        'MQ135_Air': {'fields': ['gas', 'co2', 'nh3'], 'has_air_quality': True},
        # Flow Meters
        'YF_S401': {'fields': ['flow_rate'], 'flow_range': (0.3, 6)},
        # Turbidity Sensors
        'Turbidity': {'fields': ['turbidity'], 'ntu_range': (0, 3000)},
        # Dissolved Oxygen
        'DO_Sensor': {'fields': ['dissolved_oxygen'], 'do_range': (0, 20)},
        # Conductivity
        'EC_Sensor': {'fields': ['conductivity', 'tds'], 'ec_range': (0, 20000)},
    }
